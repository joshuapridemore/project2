...
Level.prototype.actorAt = function(actor) {
  ...
  var diamondSpeed = 5;
  var diamondDist = 0.05;
  Diamond.prototype.act = function(step){
    this.wobble += step * diamondSpeed;
    var diamondPos = Math.sin(this.wobble) * diamondDist;
    this.pos = this.basePos.plus(new Vector(0, diamondPos));
  };
  ...
  Level.prototype.playerTouched = function(type, actor) {
    ...
    if (type == "lava" && this.status == null) {
      ...
      this.player.pos = new Vector(3, 3);
    }
  };
